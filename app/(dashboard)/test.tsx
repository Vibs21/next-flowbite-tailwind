            ...
            <nav className="hidden space-x-10 md:flex">
              <div className="relative">
                ...
                <button
                  type="button"
                  className="
                     pb-8' group inline-flex items-center rounded-md bg-white text-base font-medium text-gray-500 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2
                    "
              ...
              */}
                  <svg
                    className={
                      flyer === true
                        ? "ml-2 h-5 w-5 rotate-180 transform text-gray-400 transition duration-200 ease-out group-hover:text-gray-500"
                        : "ml-2 h-5 w-5 rotate-0 transform text-gray-400 transition duration-200 ease-out group-hover:text-gray-500"
                    }
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20"
                    fill="currentColor"
